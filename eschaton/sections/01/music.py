...
trinton.make_music(
    ...
    trinton.linear_attachment_command(
        ...
        selector=trinton.select_leaves_by_index([1, 3, 4, 6, 7, 10], grace=False),
    ),
    trinton.linear_attachment_command(
...
trinton.make_music(
    lambda _: trinton.select_target(_, (8,)),
    evans.RhythmHandler(
        evans.tuplet([(-1,), (3, 3, 2), (3, 2, 3), (1, 1, 1), (1,), (-1,)]),
    ),
    trinton.respell_tuplets_command(rewrite_brackets=False),
    trinton.rewrite_meter_command(boundary_depth=-1),
    trinton.aftergrace_command(
    ...
    trinton.hooked_spanner_command(
        string=r"\markup \override #'(size . .6) { \woodwind-diagram #'oboe #'((cc . (oneRT1h two three four five sixRT1h)) (lh . ()) (rh . (ees))) }",
        full_string=True,
        padding=11.25,
        style="dashed-line-with-hook",
        selector=trinton.select_leaves_by_index([0, -1], pitched=True),
...
trinton.make_music(
    lambda _: trinton.select_target(_, (8,)),
    evans.RhythmHandler(
        evans.tuplet([(-1,), (2, 3, 3), (3, 3, 2), (1, 1, 1), (1,), (-1,)]),
    ),
    trinton.respell_tuplets_command(rewrite_brackets=False),
    trinton.rewrite_meter_command(boundary_depth=-1),
    trinton.aftergrace_command(
...
trinton.make_music(
    lambda _: trinton.select_target(_, (8,)),
    evans.RhythmHandler(
        evans.tuplet([(-1,), (3, 2, 3), (2, 3, 3), (1, 1, 1), (1,), (-1,)]),
    ),
    trinton.respell_tuplets_command(rewrite_brackets=False),
    trinton.rewrite_meter_command(boundary_depth=-1),
    trinton.aftergrace_command(
